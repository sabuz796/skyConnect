  ...
  <section id="contact" class="section-fade scroll-mt-20 py-16 md:py-24 bg-[#0a0f1a]">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
      ...
      <p class="mt-8 text-sm text-neutral-500">
        <span data-i18n="hours">Phone hours: Mon-Sun 09:00-18:00 · WhatsApp support 24/7</span><br>
        Email: <a href="mailto:info@skyconnect-travels.se" class="text-[#c9a96e] hover:underline">info@skyconnect-travels.se</a>
      </p>
    </div>
  </section>
  `
